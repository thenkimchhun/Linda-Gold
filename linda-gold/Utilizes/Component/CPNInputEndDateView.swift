//
//  CPNInputEndDateView.swift
//  linda-gold
//
//  Created by Chhun on 2/8/24.
//  Copyright © 2024 Core-MVVM. All rights reserved.
//

import UIKit

class CPNInputEndDateView: BaseView {
    ...
    override func setupComponent() {
        ...
        textField.setInputViewEndDatePicker(target: self, selector: #selector(tapDone))
